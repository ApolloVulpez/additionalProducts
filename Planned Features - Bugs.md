...
| Material Pref QOL | Most of the numbers will be replaced with sliders instead for ease of use | Not started |
| Custom Departments | Ability to add your own departments to the game | Not Started |
| New licensing | Brand new licensing system that will allow players to sort via base game and modded products and allow mod creators to customize licenses so they are tailored to each mod pack. Such as naming conventions and slow progression, and also the ability to section of parts of modpacks behind licensing | Not started |
