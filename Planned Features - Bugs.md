...
|---|---|---|
| OBJ/MTL Parsing | Ability to add custom models to the game | Not started |
...
| In game creation UI | Able to make custom products live and then save them to folder, all without closing the game. So you can see texture updates, manifest changes all visually | Working on it |
